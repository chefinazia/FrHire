                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-gray-700 flex items-center">
                      <svg className="w-3 h-3 mr-2 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex">
                      ...
                      <input
                        type="text"
                        value={formData.contactInfo?.linkedin?.replace('https://linkedin.com/in/', '') || ''}
                        onChange={(e) => {
                          const value = e.target.value ? `https://linkedin.com/in/${e.target.value}` : ''
                          handleInputChange('contactInfo', 'linkedin', value)
                        }}
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-gray-700 flex items-center">
                      <svg className="w-3 h-3 mr-2 text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex">
                      ...
                      <input
                        type="text"
                        value={formData.contactInfo?.github?.replace('https://github.com/', '') || ''}
                        onChange={(e) => {
                          const value = e.target.value ? `https://github.com/${e.target.value}` : ''
                          handleInputChange('contactInfo', 'github', value)
                        }}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-r-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-gray-700 flex items-center">
                      <svg className="w-3 h-3 mr-2 text-purple-600" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-semibold text-gray-700 flex items-center">
                      <svg className="w-3 h-3 mr-2 text-sky-500" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex">
                      ...
                      <input
                        type="text"
                        value={formData.contactInfo?.twitter?.replace('https://twitter.com/', '') || ''}
                        onChange={(e) => {
                          const value = e.target.value ? `https://twitter.com/${e.target.value}` : ''
                          handleInputChange('contactInfo', 'twitter', value)
                        }}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-r-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="yourusername"
                      />
